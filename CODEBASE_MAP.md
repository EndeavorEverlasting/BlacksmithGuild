...
Never infer build, install, launcher, ACK, behavior, or live-runtime proof from a lower surface. A model cannot override the terminal state computed by the live-runtime proof-admission validator.
