...
powershell -NoProfile -ExecutionPolicy Bypass -File "%SCRIPTS%\write-launch-intent.ps1" -LaunchIntent play -BannerlordRoot "%ROOT%"
powershell -NoProfile -ExecutionPolicy Bypass -File "%SCRIPTS%\launcher-auto-nav.ps1" -LaunchIntent play -BannerlordRoot "%ROOT%" -TimeoutSec 300
exit /b %ERRORLEVEL%
