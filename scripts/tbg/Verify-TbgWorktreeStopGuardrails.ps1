...
Need $mapDoc 'Natural presentation hooks'
Need $mapDoc 'Invoke-TbgWorkflow.ps1 -Workflow agent-orchestration-map'
Need $mapDoc 'Invoke-TbgWorkflow.ps1 -Workflow route-visible-start -SummarizeOnly -ShowOrchestrationMap'
Need $mapDoc 'artifacts/latest/agent-orchestration-map.result.json'
...
Need $mapSvg 'Open PR'
Need $mapPresenterScript 'tbg.orchestrationMapPresentation.v1'
Need $mapPresenterScript "[ValidateSet('summary','paths','markdown','mermaid','mir','svg')]"
Need $mapPresenterScript 'agent-orchestration-map.result.json'
Need $mapPresenterScript 'docs\assets\agent-orchestration-map.mmd'
Need $mapPresenterScript 'docs\assets\agent-orchestration-map.mir.json'
Need $mapPresenterScript 'docs\assets\agent-orchestration-map.svg'
Need $workflowScript "[ValidateSet('route-visible-start','agent-orchestration-map')]"
Need $workflowScript 'ShowOrchestrationMap'
Need $workflowScript 'OrchestrationMapFormat'
Need $workflowScript 'Show-TbgOrchestrationMap.ps1'
