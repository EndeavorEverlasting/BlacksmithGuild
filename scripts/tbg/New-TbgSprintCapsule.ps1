...
$blockerCount=($Blockers|Measure-Object).Count;$asReady=(-not $dirty -and $blockerCount -eq 0);$sasReady=($ReadyForSysAdminSuite -and $asReady -and -not [string]::IsNullOrWhiteSpace($SysAdminSuiteOperation))
