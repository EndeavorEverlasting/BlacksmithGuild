...
function Get-TbgVisibleTradeProofTerminalStates {
    return @(
        ...
        'BLOCKED_WINDOW_LIFECYCLE_REQUIRED_ARTIFACTS_MISSING'
        'BLOCKED_WINDOW_LIFECYCLE_STALE'
        'BLOCKED_WINDOW_LIFECYCLE_QUARANTINED'
        'FAIL_SOURCE_BUILD_INSTALL_MISMATCH'
        'FAIL_STATIC_VALIDATION'
        'FAIL_WINDOW_LIFECYCLE_PARSE_ERROR'
        'FAIL_WINDOW_LIFECYCLE_CORRELATION_MISMATCH'
        'FAIL_WINDOW_LIFECYCLE_GATE'
        'FAIL_MODAL_TRANSITION_NOT_OBSERVED'
