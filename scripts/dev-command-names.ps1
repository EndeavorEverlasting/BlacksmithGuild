...
function Get-DevCommandNames {
    return @(
        ...
        'ShowForgeStatus',
        'ShowRuntimeCadence',
        'ReportSaveIdentityNow',
        'AdvanceOneDay',
        'ToggleFastForward',
        'ResumeCampaignClock',
        'ShowEngineToggleState',
        'CycleEngineToggleMode',
        'SetEngineToggleManual',
        'SetEngineToggleHybrid',
        'SetEngineToggleAutomation',
        'SetMapTradeManual',
        'SetMapTradeHybrid',
        'SetMapTradeAutomation',
