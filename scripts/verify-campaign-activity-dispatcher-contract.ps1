...
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/CampaignActivityDispatcher.cs' -Pattern 'EngineToggleAuthority.IsBoundedExecutionAllowed(EngineToggleKey.Governor)'
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/CampaignActivityDispatcher.cs' -Pattern 'public static CampaignActivityResult Started'
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/CampaignActivityDispatcher.cs' -Pattern 'public static CampaignActivityResult CompletedReadOnly'
...
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/Adapters/MarketActivityAdapter.cs' -Pattern 'MarketIntelligenceService.RunScanNow'
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/Adapters/MarketActivityAdapter.cs' -Pattern 'CompletedReadOnly'
...
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/Adapters/TradeActivityAdapter.cs' -Pattern 'MapTradeAutonomousService.TryStartGovernorTradeActivity'
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/Adapters/TradeActivityAdapter.cs' -Pattern 'CampaignActivityDispatcher.Started'
...
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/Adapters/TravelActivityAdapter.cs' -Pattern 'MapTradeAutonomousService.TryStartGovernorTravelActivity'
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/Adapters/TravelActivityAdapter.cs' -Pattern 'CampaignActivityDispatcher.Started'
...
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/Adapters/HorseMarketActivityAdapter.cs' -Pattern 'HorseMarketAtlasService.RunScanNow'
Assert-Contains -Path 'src/BlacksmithGuild/CampaignRuntime/Adapters/HorseMarketActivityAdapter.cs' -Pattern 'HerdLedgerService.RunAnalyzeNow'
