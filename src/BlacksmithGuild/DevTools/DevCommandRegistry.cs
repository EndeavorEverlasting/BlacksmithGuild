    ...
    public static class DevCommandRegistry
    {
        ...
        private static readonly HashSet<string> RegisteredCommands =
            new HashSet<string>
            {
                ...
                RuntimeCadenceGate.ShowRuntimeCadenceCommand,
                RuntimeProofContext.ReportSaveIdentityNowCommand,
                ...
                EngineToggleAuthority.SetMapTradeManualCommand,
                EngineToggleAuthority.SetMapTradeHybridCommand,
                EngineToggleAuthority.SetMapTradeAutomationCommand,
