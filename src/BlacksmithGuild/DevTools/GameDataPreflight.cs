...
namespace BlacksmithGuild.DevTools
{
    ...
    public static class GameDataPreflight
    {
        ...
        public static bool BlocksRiskyDevTools => Verdict == PreflightVerdict.Fail;
        ...
        public static void RunOnce()
        {
            ...
            try
            {
                ...
                GuildLog.Info(
                    $"[TBG PREFLIGHT] Campaign active: {Campaign.Current != null}",
                    showInGame: false
                );
                GuildLog.Info(
                    $"[TBG PREFLIGHT] MainHero available: {Hero.MainHero != null}",
                    showInGame: false
                );
