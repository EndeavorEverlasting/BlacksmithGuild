...
| Agent A | `feat/006c-4-sell-loop` @ `8316b74` | [#5](https://github.com/EndeavorEverlasting/BlacksmithGuild/pull/5) | F7 + Track A cert |
| Agent A | `feat/006c-4b-second-leg-travel` @ `5b67d6d` | [#6](https://github.com/EndeavorEverlasting/BlacksmithGuild/pull/6) | F7 + Track B cert |
